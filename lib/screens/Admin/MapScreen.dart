...
class MapScreen extends StatefulWidget {
  ...
  MapScreen({required this.latitude, required this.longitude, this.datetime, required this.changeIndex});
                      ...
                      builder: (_) => AlertDialog(
                        title: Text(
                          'Tiger: ${_profileDataList[index].title}, Added by: ${_profileDataList[index].userName}, '
                              'Latitude: ${widget.latitude}, Longitude: ${widget.longitude}, Date: ${_profileDataList[index].datetime!.toDate()}',
                          style: TextStyle(
