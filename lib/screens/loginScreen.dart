                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      try {
                                        ...
                                        // Store the email and location in shared preferences
                                      ...
                                      try {
                                        ...
                                        if (querySnapshot.docs.isNotEmpty) {
                                          ...
                                          if (userDoc.get('password') ==  _passwordController.text) {
                                            ...
                                            prefs.setString('latitude', querySnapshot.docs.first.get('latitude') );
                                            prefs.setString('longitude', querySnapshot.docs.first.get('longitude') );

                                            prefs.setString('radius', querySnapshot.docs.first.get('radius') );
